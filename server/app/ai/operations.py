...
def configuration_summary(settings: Settings) -> dict[str, Any]:
    ...
    return {
        ...
        "chat_daily_token_limit": settings.ai_chat_daily_token_limit,
        "report_daily_token_limit": settings.ai_report_daily_token_limit,
        "daily_global_token_limit": settings.ai_daily_global_token_limit,
        "max_request_tokens": settings.ai_max_request_tokens,
