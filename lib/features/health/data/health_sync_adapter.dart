      ...
      await _database
          ...
          .insert(
            db.HealthRecordsCompanion.insert(
              ...
              sleepDescription: Value(payload.sleepDescription),
              weightKg: Value(payload.weightKg),
              weightDescription: Value(payload.weightDescription),
              waterIntakeMl: Value(payload.waterIntakeMl),
              waterDescription: Value(payload.waterDescription),
              exerciseType: Value(payload.exerciseType),
              exerciseDurationMinutes: Value(payload.exerciseDurationMinutes),
              exerciseDescription: Value(payload.exerciseDescription),
              physicalStateScore: Value(payload.physicalStateScore),
              physicalStateScoreScale: Value(payload.physicalStateScoreScale),
              physicalStateDescription: Value(payload.physicalStateDescription),
