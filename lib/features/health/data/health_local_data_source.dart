        ...
        await database
            ...
            .insert(
              HealthRecordsCompanion.insert(
                ...
                sleepDescription: Value(data.sleepDescription),
                weightKg: Value(data.weightKg),
                weightDescription: Value(data.weightDescription),
                waterIntakeMl: Value(data.waterIntakeMl),
                waterDescription: Value(data.waterDescription),
                exerciseDurationMinutes: Value(data.exerciseDurationMinutes),
                exerciseDescription: Value(data.exerciseDescription),
