      ...
      await database
          ...
          .insert(
            HealthRecordsCompanion.insert(
              ...
              sleepDescription: Value(health.sleepDescription),
              weightKg: Value(health.weightKg),
              weightDescription: Value(health.weightDescription),
              waterIntakeMl: Value(health.waterIntakeMl),
              waterDescription: Value(health.waterDescription),
              exerciseType: Value(health.exerciseType),
              exerciseDurationMinutes: Value(health.exerciseDurationMinutes),
              exerciseDescription: Value(health.exerciseDescription),
