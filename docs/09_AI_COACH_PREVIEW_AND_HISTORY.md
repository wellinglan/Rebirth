...
Sprint 8B 建立本地 Request Preview 与 History；Sprint 8C/8D 已增加显式每周生成和 pending 状态恢复。Preview 仍不创建 pending、不保存 Input Snapshot，也不发送网络。当前仍没有聊天、流式输出、后台任务、自动生成或新报告类型。
