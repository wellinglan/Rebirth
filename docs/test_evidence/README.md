# Automated Test Evidence Index

Automated evidence verifies internal invariants and does not close manual
product gates.

| Sprint | Evidence |
|---|---|
| 11A.1 Today conflict recovery | `11a1_today_conflict_recovery.md` |
